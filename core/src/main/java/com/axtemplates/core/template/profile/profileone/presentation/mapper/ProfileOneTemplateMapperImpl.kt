package com.axtemplates.core.template.profile.profileone.presentation.mapper
...
open class ProfileOneTemplateMapperImpl : ProfileOneTemplateMapper {
    ...
    override fun mapUsername(state: ProfileOneBaseState): String {
        return state.username
    }

    override fun mapBio(state: ProfileOneBaseState): String {
        return state.bio
    }
